/// Code from https://github.com/lovasoa/react-contenteditable/blob/master/src/react-contenteditable.js
/// with changed `innerHtml` to `innerText`
...
export default class ContentEditable extends React.Component {
  ...
  shouldComponentUpdate(nextProps) {
    ...
    return (
      ...
      || (nextProps.html !== this.htmlEl.innerText
